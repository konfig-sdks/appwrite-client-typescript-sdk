...
// @ts-ignore
import { TeamsCreateMembershipRequest } from '../models';
// @ts-ignore
...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {TeamsCreateMembershipRequest} [teamsCreateMembershipRequest] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createMembership: async (teamId: string, teamsCreateMembershipRequest?: TeamsCreateMembershipRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('createMembership', 'teamId', teamId)
            ...
            requestBeforeHook({
                requestBody: teamsCreateMembershipRequest,
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(teamsCreateMembershipRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        getPrefs: async (teamId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('getPrefs', 'teamId', teamId)
         ...
         * @throws {RequiredError}
         */
        getUserMemberships: async (queries?: Array<string>, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/teams`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        removeTeam: async (teamId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'teamId' is not null or undefined
            assertParamExists('removeTeam', 'teamId', teamId)
            const localVarPath = `/teams/{teamId}`
                .replace(`{${"teamId"}}`, encodeURIComponent(String(teamId !== undefined ? teamId : `-teamId-`)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const TeamsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Invite a new member to join your team. Provide an ID for existing users, or invite unregistered users using an email or phone number. If initiated from a Client SDK, Appwrite will send an email or sms with a link to join the team to the invited user, and an account will be created for them if one doesn\'t exist. If initiated from a Server SDK, the new member will be added automatically to the team.  You only need to provide one of a user ID, email, or phone number. Appwrite will prioritize accepting the user ID > email > phone number if you provide more than one of these parameters.  Use the `url` parameter to redirect the user from the invitation email to your app. After the user is redirected, use the [Update Team Membership Status](https://appwrite.io/docs/references/cloud/client-web/teams#updateMembershipStatus) endpoint to allow the user to accept the invitation to the team.   Please note that to avoid a [Redirect Attack](https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Unvalidated_Redirects_and_Forwards_Cheat_Sheet.md) Appwrite will accept the only redirect URLs under the domains you have added as a platform on the Appwrite Console. 
         * @summary Create team membership
         * @param {TeamsApiCreateMembershipRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async createMembership(requestParameters: TeamsApiCreateMembershipRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Membership>> {
            const teamsCreateMembershipRequest: TeamsCreateMembershipRequest = {
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.createMembership(requestParameters.teamId, teamsCreateMembershipRequest, options);
         ...
         * Get the team\'s shared preferences by its unique ID. If a preference doesn\'t need to be shared by all team members, prefer storing them in [user preferences](https://appwrite.io/docs/references/cloud/client-web/account#getPrefs).
         * @summary Get team preferences
         * @param {TeamsApiGetPrefsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getPrefs(requestParameters: TeamsApiGetPrefsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: any; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getPrefs(requestParameters.teamId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get a list of all the teams in which the current user is a member. You can use the parameters to filter your results.
         * @summary List teams
         * @param {TeamsApiGetUserMembershipsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getUserMemberships(requestParameters: TeamsApiGetUserMembershipsRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TeamList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserMemberships(requestParameters.queries, requestParameters.search, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Use this endpoint to list a team\'s members using the team\'s ID. All team members have read access to this endpoint.
        ...
        async removeTeam(requestParameters: TeamsApiRemoveTeamRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.removeTeam(requestParameters.teamId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Modify the roles of a team member. Only team members with the owner role have access to this endpoint. Learn more about [roles and permissions](https://appwrite.io/docs/permissions). 
...
export const TeamsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createMembership(requestParameters: TeamsApiCreateMembershipRequest, options?: AxiosRequestConfig): AxiosPromise<Membership> {
         ...
         * @throws {RequiredError}
         */
        getPrefs(requestParameters: TeamsApiGetPrefsRequest, options?: AxiosRequestConfig): AxiosPromise<{ [key: string]: any; }> {
            return localVarFp.getPrefs(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * Get a list of all the teams in which the current user is a member. You can use the parameters to filter your results.
         * @summary List teams
         ...
         * @throws {RequiredError}
         */
        getUserMemberships(requestParameters: TeamsApiGetUserMembershipsRequest, options?: AxiosRequestConfig): AxiosPromise<TeamList> {
...
/**
 * Request parameters for createMembership operation in TeamsApi.
 * @export
 * @interface TeamsApiCreateMembershipRequest
 */
export type TeamsApiCreateMembershipRequest = {
    
    /**
    * Team ID.
    * @type {string}
    * @memberof TeamsApiCreateMembership
    */
...
/**
 * Request parameters for getPrefs operation in TeamsApi.
 * @export
 * @interface TeamsApiGetPrefsRequest
 */
export type TeamsApiGetPrefsRequest = {
    
    /**
    * Team ID.
    * @type {string}
    * @memberof TeamsApiGetPrefs
    */
    readonly teamId: string
...
/**
 * Request parameters for getUserMemberships operation in TeamsApi.
 * @export
 * @interface TeamsApiGetUserMembershipsRequest
 */
export type TeamsApiGetUserMembershipsRequest = {
    ...
    * @type {Array<string>}
    * @memberof TeamsApiGetUserMemberships
    */
...
export class TeamsApiGenerated extends BaseAPI {
     ...
     */
    public createMembership(requestParameters: TeamsApiCreateMembershipRequest, options?: AxiosRequestConfig) {
        return TeamsApiFp(this.configuration).createMembership(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamsApiGenerated
     */
    public getPrefs(requestParameters: TeamsApiGetPrefsRequest, options?: AxiosRequestConfig) {
        return TeamsApiFp(this.configuration).getPrefs(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TeamsApiGenerated
     */
    public getUserMemberships(requestParameters: TeamsApiGetUserMembershipsRequest, options?: AxiosRequestConfig) {
        return TeamsApiFp(this.configuration).getUserMemberships(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
