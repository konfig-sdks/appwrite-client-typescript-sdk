...
export const AvatarsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        generateQrCodeImage: async (text: string, size?: number, margin?: number, download?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'text' is not null or undefined
            assertParamExists('generateQrCodeImage', 'text', text)
         ...
         * @throws {RequiredError}
         */
        getBrowserIconByCode: async (code: 'aa' | 'an' | 'ch' | 'ci' | 'cm' | 'cr' | 'ff' | 'sf' | 'mf' | 'ps' | 'oi' | 'om' | 'op' | 'true', width?: number, height?: number, quality?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'code' is not null or undefined
            assertParamExists('getBrowserIconByCode', 'code', code)
...
export const AvatarsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * Converts a given plain text to a QR code image. You can use the query parameters to change the size and style of the resulting image. 
         * @summary Get QR code
         * @param {AvatarsApiGenerateQrCodeImageRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async generateQrCodeImage(requestParameters: AvatarsApiGenerateQrCodeImageRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.generateQrCodeImage(requestParameters.text, requestParameters.size, requestParameters.margin, requestParameters.download, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * You can use this endpoint to show different browser icons to your users. The code argument receives the browser code as it appears in your user [GET /account/sessions](https://appwrite.io/docs/references/cloud/client-web/account#getSessions) endpoint. Use width, height and quality arguments to change the output settings.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px.
         * @summary Get browser icon
         * @param {AvatarsApiGetBrowserIconByCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getBrowserIconByCode(requestParameters: AvatarsApiGetBrowserIconByCodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getBrowserIconByCode(requestParameters.code, requestParameters.width, requestParameters.height, requestParameters.quality, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * You can use this endpoint to show different country flags icons to your users. The code argument receives the 2 letter country code. Use width, height and quality arguments to change the output settings. Country codes follow the [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) standard.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px. 
         * @summary Get country flag
         * @param {AvatarsApiGetCountryFlagByCodeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        async getCountryFlagByCode(requestParameters: AvatarsApiGetCountryFlagByCodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCountryFlagByCode(requestParameters.code, requestParameters.width, requestParameters.height, requestParameters.quality, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * The credit card endpoint will return you the icon of the credit card provider you need. Use width, height and quality arguments to change the output settings.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px. 
...
export const AvatarsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        generateQrCodeImage(requestParameters: AvatarsApiGenerateQrCodeImageRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.generateQrCodeImage(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * You can use this endpoint to show different browser icons to your users. The code argument receives the browser code as it appears in your user [GET /account/sessions](https://appwrite.io/docs/references/cloud/client-web/account#getSessions) endpoint. Use width, height and quality arguments to change the output settings.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px.
         * @summary Get browser icon
         ...
         * @throws {RequiredError}
         */
        getBrowserIconByCode(requestParameters: AvatarsApiGetBrowserIconByCodeRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getBrowserIconByCode(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * You can use this endpoint to show different country flags icons to your users. The code argument receives the 2 letter country code. Use width, height and quality arguments to change the output settings. Country codes follow the [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) standard.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px. 
         * @summary Get country flag
         ...
         * @throws {RequiredError}
         */
        getCountryFlagByCode(requestParameters: AvatarsApiGetCountryFlagByCodeRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getCountryFlagByCode(requestParameters, options).then((request) => request(axios, basePath));
        },
        /**
         * The credit card endpoint will return you the icon of the credit card provider you need. Use width, height and quality arguments to change the output settings.  When one dimension is specified and the other is 0, the image is scaled with preserved aspect ratio. If both dimensions are 0, the API provides an image at source quality. If dimensions are not specified, the default size of image returned is 100x100px. 
         * @summary Get credit card icon
...
/**
 * Request parameters for generateQrCodeImage operation in AvatarsApi.
 * @export
 * @interface AvatarsApiGenerateQrCodeImageRequest
 */
export type AvatarsApiGenerateQrCodeImageRequest = {
    
    /**
    * Plain text to be converted to QR code image.
    * @type {string}
    * @memberof AvatarsApiGenerateQrCodeImage
    */
...
/**
 * Request parameters for getBrowserIconByCode operation in AvatarsApi.
 * @export
 * @interface AvatarsApiGetBrowserIconByCodeRequest
 */
export type AvatarsApiGetBrowserIconByCodeRequest = {
    
    /**
    * Browser Code.
    * @type {'aa' | 'an' | 'ch' | 'ci' | 'cm' | 'cr' | 'ff' | 'sf' | 'mf' | 'ps' | 'oi' | 'om' | 'op' | 'true'}
    * @memberof AvatarsApiGetBrowserIconByCode
    */
...
/**
 * Request parameters for getCountryFlagByCode operation in AvatarsApi.
 * @export
 * @interface AvatarsApiGetCountryFlagByCodeRequest
 */
export type AvatarsApiGetCountryFlagByCodeRequest = {
    ...
    * @memberof AvatarsApiGetCountryFlagByCode
    */
...
export class AvatarsApiGenerated extends BaseAPI {
     ...
     */
    public generateQrCodeImage(requestParameters: AvatarsApiGenerateQrCodeImageRequest, options?: AxiosRequestConfig) {
        return AvatarsApiFp(this.configuration).generateQrCodeImage(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AvatarsApiGenerated
     */
    public getBrowserIconByCode(requestParameters: AvatarsApiGetBrowserIconByCodeRequest, options?: AxiosRequestConfig) {
        return AvatarsApiFp(this.configuration).getBrowserIconByCode(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AvatarsApiGenerated
     */
    public getCountryFlagByCode(requestParameters: AvatarsApiGetCountryFlagByCodeRequest, options?: AxiosRequestConfig) {
        return AvatarsApiFp(this.configuration).getCountryFlagByCode(requestParameters, options).then((request) => request(this.axios, this.basePath));
    }
