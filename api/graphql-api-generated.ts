...
export const GraphqlApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        executeMutationOperation: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const GraphqlApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async executeMutationOperation(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: any; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.executeMutationOperation(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const GraphqlApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        executeMutationOperation(options?: AxiosRequestConfig): AxiosPromise<{ [key: string]: any; }> {
            return localVarFp.executeMutationOperation(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GraphqlApiGenerated extends BaseAPI {
     ...
     * @memberof GraphqlApiGenerated
     */
    public executeMutationOperation(options?: AxiosRequestConfig) {
        return GraphqlApiFp(this.configuration).executeMutationOperation(options).then((request) => request(this.axios, this.basePath));
    }
}
