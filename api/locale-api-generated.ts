...
export const LocaleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getEUCountries: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getUserLocale: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        listCountriesPhones: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LocaleApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getCurrencies(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CurrencyList>> {
         ...
         * @throws {RequiredError}
         */
        async getEUCountries(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CountryList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getEUCountries(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Get the current user location based on IP. Returns an object with user country code, country name, continent name, continent code, ip address and suggested currency. You can use the locale header to get the data in a supported language.  ([IP Geolocation by DB-IP](https://db-ip.com))
         ...
         * @throws {RequiredError}
         */
        async getUserLocale(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Locale>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getUserLocale(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List of all locale codes in [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes).
         ...
         * @throws {RequiredError}
         */
        async listCountriesPhones(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PhoneList>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listCountriesPhones(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * List of all languages classified by ISO 639-1 including 2-letter code, name in English, and name in the respective language.
         ...
         * @throws {RequiredError}
         */
        async listLanguages(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LanguageList>> {
...
export const LocaleApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getCurrencies(options?: AxiosRequestConfig): AxiosPromise<CurrencyList> {
         ...
         * @throws {RequiredError}
         */
        getEUCountries(options?: AxiosRequestConfig): AxiosPromise<CountryList> {
            return localVarFp.getEUCountries(options).then((request) => request(axios, basePath));
        },
        /**
         * Get the current user location based on IP. Returns an object with user country code, country name, continent name, continent code, ip address and suggested currency. You can use the locale header to get the data in a supported language.  ([IP Geolocation by DB-IP](https://db-ip.com))
         * @summary Get user locale
         ...
         * @throws {RequiredError}
         */
        getUserLocale(options?: AxiosRequestConfig): AxiosPromise<Locale> {
            return localVarFp.getUserLocale(options).then((request) => request(axios, basePath));
        },
        /**
         * List of all locale codes in [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes).
         * @summary List Locale Codes
         ...
         * @throws {RequiredError}
         */
        listCountriesPhones(options?: AxiosRequestConfig): AxiosPromise<PhoneList> {
            return localVarFp.listCountriesPhones(options).then((request) => request(axios, basePath));
        },
        /**
         * List of all languages classified by ISO 639-1 including 2-letter code, name in English, and name in the respective language.
         * @summary List languages
         ...
         * @throws {RequiredError}
         */
        listLanguages(options?: AxiosRequestConfig): AxiosPromise<LanguageList> {
...
export class LocaleApiGenerated extends BaseAPI {
    ...
    public getCurrencies(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).getCurrencies(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocaleApiGenerated
     */
    public getEUCountries(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).getEUCountries(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocaleApiGenerated
     */
    public getUserLocale(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).getUserLocale(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof LocaleApiGenerated
     */
    public listCountriesPhones(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).listCountriesPhones(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public listLanguages(options?: AxiosRequestConfig) {
        return LocaleApiFp(this.configuration).listLanguages(options).then((request) => request(this.axios, this.basePath));
    }
}
